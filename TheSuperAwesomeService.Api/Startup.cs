...
namespace TheSuperAwesomeService.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<ServiceContext>(opt =>
               opt.UseInMemoryDatabase("PricingService"));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "The Super Awesome Service API", Version = "v1" });
            });
        }
